                ...
                <Grid container>
                  ...
                  <Grid container sx={{ alignItems:"center",justifyContent:"center",mt:"10px"}}>
                    <Grid item xs={12} sm={12} md={6} lg={6} >
                      <Typography sx={{ fontSize: { lg: '19px', md: '17px', sm: '15px', xs: '14px' },mr:"15px", display: 'flex', justifyContent: {xs:'center',sm:"center",md:"right",lg:"right"}, alignItems: 'center' }}>
                        Name:
                      </Typography>
                      </Grid>
                      <Grid item xs={12} sm={12} md={6} lg={6}>
                      ...
                      <Typography sx={{whiteSpace: 'nowrap',fontSize: { lg: '19px', md: '17px', sm: '15px', xs: '14px' },mr:"15px", display: 'flex', justifyContent: {xs:'center',sm:"center",md:"right",lg:"right"}, alignItems: 'center' }}>
